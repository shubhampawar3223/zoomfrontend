...
export default function Signup(){
    ...
    const submit= async(e)=>{
      e.preventDefault();
      setLoading(true);
      const url="https://zoom-bclone.herokuapp.com/signup";
    ...
    
{
      ...
      :null
        ...
        <div className="offset-1 col-5 border"style={{borderRadius:"10px", backgroundColor:"#b0b2b5", boxShadow:"-5px 10px 20px #888888" }}>
            <h2 className="text-center " style={{marginTop:"15%",fontWeight:"bold" }}>Sign Up</h2>    
            <div className="text-center"><i class="fa fa-user-plus fa-3x" aria-hidden="true"></i></div>
        </div>
        <div className=" border  col-5" style={{borderRadius:"10px", boxShadow:"5px 10px 18px #888888"}}>
               <div className="form-group p-3">
               <small className="mt-2">Name</small>
                   <input type="text" ref={nameRef} className="form-control" placeholder="Enter Your Name" required></input>
